    ...
    public function getConfigTreeBuilder()
    {
		...
		$rootNode
			->children()
                ...
                ->scalarNode('basepath')->defaultValue('%kernel.root_dir%/../web')->end()
                ->booleanNode('clientSideStorage')->defaultTrue()->end()
                ->scalarNode('localStorageName')->defaultValue('epiceditor')->end()
                ->scalarNode('parser')->defaultValue('marked')->end()
                ->booleanNode('focusOnLoad')->defaultFalse()->end()
                ->arrayNode('file')
                    ->children()
                        ->scalarNode('name')->defaultValue('epiceditor')->end()
                        ->scalarNode('defaultContent')->end()
